...
cLEL      = 0*0.01;   % transaction-cost intensity gamma (paper notation)
...
save('results.mat', 'N','time_per_Run', 'SolVector');
...
Retmin = -1.5;  Retmax = 1.5;     % log-return bounds
Vmin   = 1e-4/10; Vmax  = 0.3*0.2/0.3;   % variance bounds
